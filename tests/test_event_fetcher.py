...
class TestBucketMappings:
    ...
    def test_bucket_by_client_mapping(self) -> None:
        ...
        test_data = {
            'buckets': {
                'aw-watcher-window_host1': create_test_bucket('aw-watcher-window_host1', 'aw-watcher-window'),
                'aw-watcher-window_host2': create_test_bucket('aw-watcher-window_host2', 'aw-watcher-window'),
                'aw-watcher-afk_host1': create_test_bucket('aw-watcher-afk_host1', 'aw-watcher-afk'),
            }
        }
    ...
    def test_bucket_short_mapping(self) -> None:
        ...
        test_data = {
            'buckets': {
                'aw-watcher-window_test': create_test_bucket('aw-watcher-window_test', 'aw-watcher-window'),
        ...
        test_data = {
            ...
            'events': {
                'aw-watcher-window_test': [
                    ...
                    create_test_event(base_time + timedelta(minutes=5), 60, {'title': 'Event 2'}),  # 10:05 - 10:06
                    create_test_event(base_time + timedelta(minutes=10), 60, {'title': 'Event 3'}),  # 10:10 - 10:11
                ]
            }
        }
...
class TestGetCorrespondingEvent:
    ...
    def test_find_corresponding_event_simple(self) -> None:
        ...
        test_data = {
            'buckets': {
                'aw-watcher-window_test': create_test_bucket('aw-watcher-window_test', 'aw-watcher-window'),
                'aw-watcher-web-chrome_test': create_test_bucket('aw-watcher-web-chrome_test', 'aw-watcher-web-chrome'),
            },
            'events': {
        ...
        result = fetcher.get_corresponding_event(window_event, 'aw-watcher-web-chrome_test', ignorable=True)
    ...
    def test_filters_out_very_short_events(self) -> None:
        ...
        test_data = {
            ...
            'events': {
                'aw-watcher-web-chrome_test': [
                    create_test_event(window_time, 1, {'url': 'https://too-short.com'}),  # Very short
