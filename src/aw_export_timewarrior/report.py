...
def format_as_table(
    ...
    for row in data:
        ...
        if all_columns:
            ...
            print(f"{time_str:<8} {duration_str:<8} {window_title:<50} {app:<15} {spec_type:<8} {specialized:<60} {afk:<8} {tags_str}")
        else:
            print(f"{time_str:<8} {duration_str:<8} {window_title:<50} {specialized:<60} {afk:<8} {tags_str}")
...
def format_as_csv(
    ...
    # Write header
    if all_columns:
        headers = ['timestamp', 'duration_seconds', 'window_title', 'app',
                  'specialized_type', 'specialized_data', 'afk_status', 'tags']
    else:
        headers = ['timestamp', 'duration_seconds', 'window_title',
                  'specialized_data', 'afk_status', 'tags']
